...
You can attach events to datasources to trigger certain actions when a datasource is updated. See [Events on datasources](events.md#example-2-attaching-an-event-to-a-datasource) for more information.